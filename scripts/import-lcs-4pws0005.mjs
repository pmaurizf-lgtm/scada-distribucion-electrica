/**
 * Importa cadena ABT-6PWS0005 → TRF-6PWS0005 → LCS-4PWS0005
...
const LCS = 'LCS-4PWS0005'
const TRF = 'TRF-6PWS0005'
const ABT = 'ABT-6PWS0005'
...
const r440 = extractVoltage(s440, '440', localMap, 401)
...
if (!data.chains.some((c) => c.loadCenterId === LCS)) {
  data.chains.push({
    ...
    transformerId: TRF,
    loadCenterId: LCS,
    transformerName: 'TRANSFORMADOR Nº5 690V/440V-230V',
    loadCenterName: 'CENTRO DE CARGA N-5',
    ratings: {
      kVA: '660 / 570 / 90',
      primaryV: '690',
      secondary440V: '440',
...
data._comment =
  'Cadenas ABT-6PWS0001/0002/0003/0004/0005 → TRF → LCS-4PWS0001/0002/0003/0004/0005 desde Excel 440V/230V Power System. Devanados TRF virtuales; QVS-440/230 entradas.'
